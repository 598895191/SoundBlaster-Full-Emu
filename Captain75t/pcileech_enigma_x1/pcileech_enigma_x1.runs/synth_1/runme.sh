...
HD_PWD='C:/Users/jeffr/OneDrive/Escritorio/SoundBlaster Full Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcileech_enigma_x1_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcileech_enigma_x1_top.tcl
