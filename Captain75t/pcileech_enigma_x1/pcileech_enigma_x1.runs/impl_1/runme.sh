...
HD_PWD='C:/Users/jeffr/OneDrive/Escritorio/SoundBlaster Full Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pcileech_enigma_x1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcileech_enigma_x1_top.tcl -notrace
