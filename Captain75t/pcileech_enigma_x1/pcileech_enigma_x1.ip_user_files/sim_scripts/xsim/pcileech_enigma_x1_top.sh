...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L fifo_generator_v13_2_10 -L dist_mem_gen_v8_0_15 -L blk_mem_gen_v8_4_8 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot pcileech_enigma_x1_top xil_defaultlib.pcileech_enigma_x1_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcileech_enigma_x1_top -key {Behavioral:sim_1:Functional:pcileech_enigma_x1_top} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_10 dist_mem_gen_v8_0_15 blk_mem_gen_v8_4_8)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcileech_enigma_x1_top.wdb xsim.dir libdpi.so)
