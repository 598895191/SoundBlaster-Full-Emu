...
#
# Script generated by Vivado on Wed Jul 24 22:37:42 -0500 2024
...
design_libs=(xpm xil_defaultlib fifo_generator_v13_2_10 dist_mem_gen_v8_0_15 blk_mem_gen_v8_4_8)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  ...
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  ...
  vlogan -work dist_mem_gen_v8_0_15 $vlogan_opts +v2k +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../pcileech_enigma_x1.srcs/sources_1/imports/src" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_com.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_fifo.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_ft601.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_mux.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_pcie_a7.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_pcie_cfg_a7.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_pcie_tlp_a7.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_tlps128_bar_controller.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_tlps128_cfgspace_shadow.sv" \
  "../../../../../../SoundBlaster/ Full/ Emu/Captain75t/pcileech_enigma_x1/pcileech_enigma_x1.srcs/sources_1/imports/src/pcileech_enigma_x1_top.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcileech_enigma_x1_top xil_defaultlib.glbl -o pcileech_enigma_x1_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcileech_enigma_x1_top_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pcileech_enigma_x1_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcileech_enigma_x1_top_simv.daidir vcs_lib c.obj)
